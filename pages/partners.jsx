...
export default function Partners() {
    ...
    return (
      ...
      <img width="400" src="/img/bck4.png" />
            ...
            <a href="https://discord.gg/8WkhJXmrbq">
                        <div className="flex-1 gap-x-4 flex items-center bg-gradient-to-b from-neutral-900/80 to-neutral-900/20 p-3 rounded-full">
                            <img className="rounded-full h-32 w-32" src="https://cdn.discordapp.com/icons/1062046880160288919/d7d30a284d0d8a8154341b985ccef18f.png?size=2048" />
                            <div>
                                <h1 className="leading-none text-3xl font-bold text-white">Cloud Café</h1>        
                                <div className="flex items-center mt-1">
                                    <p className="font-normal font-sm">
                                        Share Your Codes, Get other's code , coding, gaming etc...
                                    </p>
                                </div>     
                            </div>
                        </div>
